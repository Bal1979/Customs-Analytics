...
const arch = makeDoc([
  ...
  H2("Analyse-dashboards"),
  P("Kernen i værktøjet er syv analysesider, der belyser importporteføljen: Oversigt (toldværdi, told, effektiv toldsats, verdenskort og udvikling over tid), Leverandører, Sourcing (pr. oprindelsesland og HS-kode), Procedurekoder, Transport, FTA-muligheder (uudnyttet præference) og Klassifikation (samme vare på forskellige HS-koder)."),
  H2("Risici & muligheder (konsolideret analyse)"),
  P("customs/risk_analysis.py samler porteføljens optimerings- og risikosignaler til én oversigt: besparelsespotentiale (uudnyttet FTA), toldrisiko (påberåbte præferencer uden kendt aftale — told der kan kræves), fejlklassificering og EDR-anomalier (vareposter hvor faktisk effektiv toldsats afviger væsentligt fra forventet, beløbsvægtet). Præsenteres som porteføljetal plus en prioriteret, beløbssorteret liste."),
  P("Vigtigt: dette er en ANALYSE på tværs af en portefølje af tolddata — trends, risici og optimeringsmuligheder — ikke en godkendt/afvist-vurdering af en enkelt angivelse. Regelkataloget dokumenterer de underliggende tjek; det driver ingen compliance-dom."),
  ...
  table(["Modul", "Ansvar"], [
    ...
    ["customs/risk_analysis.py", "Konsolideret risiko/mulighed-analyse + EDR-anomalier (porteføljetal)"],
    ["customs/sanity.py", "Struktur-/konsistens-kontroller (CUS-W/H/C/V/O/P01)"],
    ["customs/xsd_validation.py", "XSD-strukturvalidering af DMS-XML (CUS-X01)"],
